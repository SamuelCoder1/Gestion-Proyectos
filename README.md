...
If the database does not exist, Spring Boot will create it automatically.
...
▶️ Run Order
Start Backend (Spring Boot) on http://localhost:8080
...
Selecciona JDK 17 (Amazon Corretto)
...
spring.jpa.hibernate.ddl-auto=update
Si la base de datos no existe, Spring Boot la creará automáticamente.
